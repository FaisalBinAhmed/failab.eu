			...
			<div className="flex flex-col items-center bg-black bg-dot-white/[0.2] w-full py-8">
				...
				<div className="flex flex-row flex-wrap justify-center gap-4 p-4 mt-8">
					<ReviewCard
						...
						content={
							<p>
								...
								fantastic app. The developer responds quickly and 100% to
								requests and suggestions. I can't recommend this app highly
								enough...
							</p>
						}
					/>
					<ReviewCard
						...
						content={
							<p>
								Incredible extension. I tried other auto grouping extensions
								such as Mark Tab Manager, but my browser became a mess as it
								tried to group already opened tabs and windows, and it did not
								play well with The Marvellous Suspender, which is a must have
								for me to reduce my memory footprint since I open LOTS of tabs.{" "}
								<Highlight>
									{" "}
					...
					<ReviewCard
						...
						content={
							<p>
								...
								showing). Moving to a new M1 Mac I didn't want to install
								Rosetta just for this feature. Scaler Bandwidth Monitor does
								exactly what I want and does it beautifully. Minimal design and
								a modern app. Fantastic.{" "}
								<Highlight>
